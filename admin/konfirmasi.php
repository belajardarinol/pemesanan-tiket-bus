...
// var_dump($id_pesan);
$edit   = "SELECT pesanan.nama, pesanan.id_bus, pesanan.id_berangkat, pesanan.tgl_pesan, pesanan.nik, pesanan.alamat,
 pesanan.tgl_berangkat, pesanan.total, pesanan.konfirm, keberangkatan.tujuan, keberangkatan.jadwal, bus.kelas, bus.harga
  FROM pesanan, bus, keberangkatan, kursi_pesanan, kursi WHERE pesanan.id_pesan = '$id_pesan' AND kursi_pesanan.id_pesan 
  = pesanan.id_pesan = kursi.id_pesan AND keberangkatan.id_berangkat = pesanan.id_berangkat AND bus.id_bus = pesanan.id_bus";
