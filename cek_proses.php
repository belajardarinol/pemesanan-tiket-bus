...
<div class="col-md-12">
    ...
    <form class="form-horizontal" action="" method="POST">
        <div class="form-group">
            ...
            <div class="col-sm-7">
                <?php if (isset($_GET['kode'])) { ?>
                    <input name="invoice" class="form-control" placeholder="Kode Pemesanan" value="<?php echo $_GET['kode']; ?>">
                <?php } else { ?>
        ...
        <center>
            ...
            $query  = mysqli_query($conn, "SELECT pesanan.id_pesan, pesanan.nama, pesanan.id_bus, pesanan.id_berangkat,
             pesanan.tgl_pesan, pesanan.nik, pesanan.alamat, pesanan.tgl_berangkat, pesanan.total, pesanan.invoice, pesanan.konfirm, 
             pesanan.respons, pesanan.pembayaran, keberangkatan.tujuan, keberangkatan.jadwal, bus.kelas, bus.harga FROM pesanan, bus,
              keberangkatan, kursi_pesanan, kursi WHERE pesanan.invoice = '$invoice'") or die(mysqli_error($conn));
            ...
            ?>
                    ...
                    <a href="cetak_tiket.php?id_pesan=<?php echo $data['id_pesan']; ?>" class="btn btn-primary">
                        Cetak Tiket</a>
            <?php
                }
            }
