    ...
    <div class="panel panel-default"">
        <div class="panel-body">
            <div class="row-table-bordered">
                ...
                <br>
                <div class="col-md-4">
                    <font size="4"><b><p class="text-center">P.O. Puspa jaya Pondok Ungu</p></font>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php 
                                        ...
                                        $query  = mysqli_query($conn, "SELECT * FROM kursi_pesanan WHERE id_pesan = '$id_pesan'")or die(mysqli_error($conn));
                                ...
                                <td>
                                    <?php
                                        $query  = mysqli_query($conn, "SELECT total FROM pesanan WHERE id_pesan = '$id_pesan'")or die(mysqli_error($conn));
