    ...
    <div class="panel panel-default"">
        ...
        <div class="row-table-bordered">
            ...
            <div class="col-md-4">
                ...
                <font size="3"><b>
                        <p class="text-center">Jl. Sultan Agung Raya KM. 27 No. 24, Bekasi Barat, Bekasi.</p>
                </font>
                <b>
        ...
        <table border="1" style="" align="center">
            ...
            while ($row = mysqli_fetch_array($tampil1)) { ?>
                ...
                <tr>
                    ...
                    <td>
                        <center><?php echo $row['tgl_berangkat']; ?>
                    </td>
                    <td>
                        <center><?php echo $row['tujuan']; ?>
                    </td>
                    <td>
