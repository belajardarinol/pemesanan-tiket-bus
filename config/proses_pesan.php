...
if ($jumlah = 0) {
	...
	$insert			= "INSERT INTO pesanan (id_pesan, id_bus, id_berangkat, nik, nama, alamat, tgl_pesan, tgl_berangkat, qty, total, fixed, invoice, konfirm, respons, pembayaran) VALUES ('$id_pesan','$id_bus','$id_berangkat','$nik','$nama','$alamat','$tgl_pesan','$tgl_berangkat','$penumpang','$total','0','$invoice','0','','0')";
	// var_dump($insert);
	// die;
