...
if ($jumlah = 0) {
	...
	// $id_pesan		= mt_rand(1, 1000);
	$insert			= "INSERT INTO pesanan (id_pesan, id_bus, id_berangkat, nik, nama, alamat, tgl_pesan, tgl_berangkat, qty, total, fixed, invoice, konfirm, respons, pembayaran) VALUES ('0','$id_bus','$id_berangkat','$nik','$nama','$alamat','$tgl_pesan','$tgl_berangkat','$penumpang','$total','0','$invoice','0','','0')";
	// var_dump($insert);
	// die;
	...
	echo "<META HTTP-EQUIV='REFRESH' CONTENT ='0; URL=../index.php?halaman=kursi&&id_pesan=$data[id_pesan]&&jumlah=$data[qty]&&tgl_berangkat=$tgl_berangkat'>";
}
